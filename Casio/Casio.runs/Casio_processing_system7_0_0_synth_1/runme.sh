...
HD_PWD='C:/Users/Jesper Kirial/project_5/project_5.runs/Casio_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Casio_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Casio_processing_system7_0_0.tcl
