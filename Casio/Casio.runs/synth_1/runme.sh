...
HD_PWD='C:/Users/Jesper Kirial/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Casio_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Casio_wrapper.tcl
