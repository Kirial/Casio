...
HD_PWD='C:/Users/Jesper Kirial/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Casio_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Casio_wrapper.tcl -notrace
